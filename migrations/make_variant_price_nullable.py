"""
Migration script to make price column nullable in product_variants table.

Run this script to update your database schema:
    python migrations/make_variant_price_nullable.py
"""
import sys
import os
...
def run_migration():
    """Run the migration to make price column nullable in product_variants table"""
    ...
    with engine.connect() as conn:
        ...
        try:
            ...
            if price_row and price_row[0] == 'NO':
                print("Making price column nullable in product_variants table...")
                conn.execute(text("""
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migration: Make variant price nullable")
    print("=" * 60)
